...
export class NavController {
    constructor(nav, startingNode) {
        ...
        this.getIteration = () => {
            ...
            return ((_a = this.nameMap[name]) === null || _a === void 0 ? void 0 : _a.iteration) || -1;
        };
        this.getSize = () => {
            return this.size;
        };
        ...
        this.move = (dy, dx) => {
            ...
            if (((_b = this.nav[ny]) === null || _b === void 0 ? void 0 : _b[nx]) === undefined) {
                if (((_c = this.nav[ny]) === null || _c === void 0 ? void 0 : _c.length) === 0 || nx <= 0) {
                    return this.getLocation();
                }
